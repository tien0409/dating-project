...
import styles from "./MoreInformationItem.module.scss";
import useMoreInformationItem from "./MoreInformationItemHook";

const cln = classNames.bind(styles);

type MoreInformationItemProps = {
  icon: IconType;
  title: string;
  isSwitch?: boolean;
...
const MoreInformationItem = (props: MoreInformationItemProps) => {
  const { icon: Icon, title, isSwitch, menuItems = [] } = props;

  const { open, setOpen } = useMoreInformationItem();
